...
export const DEFAULT_PROVIDERS: CDNProvider[] = [
  // 全球源
  {
    ...
    searchApi: 'https://data.jsdelivr.com/v1/packages?name={package}&type=npm',
    versionsApi: 'https://data.jsdelivr.com/v1/packages/npm/{package}',
    packageInfoApi: 'https://data.jsdelivr.com/v1/packages/npm/{package}@{version}',
    supportESM: true,
